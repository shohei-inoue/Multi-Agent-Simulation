...
def setup_verification_environment():
    ...
    # 基本設定
    sim_param.episodeNum = 10  # テスト用に1エピソード
    sim_param.maxStepsPerEpisode = 50  # テスト用に50ステップ
...
def run_verification():
    ...
    try:
        ...
        # 7. 結果保存用ディレクトリ作成
        output_dir = "verification_results/Config_C_obstacle_0.0"
