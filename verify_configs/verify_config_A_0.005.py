...
def setup_verification_environment():
    ...
    # 基本設定
    sim_param.episodeNum = 10  # 並列処理のため3回に削減
...
def run_verification():
    """検証実行"""
    print(f"=== Config_A 検証開始 (障害物密度: 0.005) ===")
    ...
    try:
        ...
        # 結果保存用ディレクトリ作成
        output_dir = f"verification_results/Config_A_obstacle_0.005"
