...
def run_training():
    ...
    try:
        ...
        for episode in range(sim_param.episodeNum):
            ...
            system_reward = 0.0
            episode_rewards = {swarm_id: 0.0 for swarm_id in swarm_agents.keys()} # SwarmAgentごとの報酬を蓄積
            ...
            if episode % 50 == 0:
                ...
                print(f"    平均探査率: {avg_exploration:.3f}, ベスト探査率: {best_exploration_rate:.3f}, 平均システム報酬: {avg_system_reward:.3f}")
